...
public class Myfour extends View {

    private final static String TAG=Mythree.class.getSimpleName();
    private Paint mPaint;
    private RectF oval;

    public Myfour(Context context){
        super(context);
        init();
    }

    public Myfour(Context context, AttributeSet attrs){
        super(context, attrs);
        init();
    }

    public Myfour(Context context, AttributeSet attrs, int defStyleAttr){
