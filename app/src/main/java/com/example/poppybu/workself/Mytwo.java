...
public class Mytwo extends View {

    private final static String TAG=Mythree.class.getSimpleName();
    private Paint mPaint;
    private RectF oval;

    public Mytwo(Context context){
        super(context);
        init();
    }

    public Mytwo(Context context, AttributeSet attrs){
        super(context, attrs);
        init();
    }

    public Mytwo(Context context, AttributeSet attrs, int defStyleAttr){
