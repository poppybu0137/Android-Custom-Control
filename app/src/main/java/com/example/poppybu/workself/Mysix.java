...
public class Mysix extends View {

    private final static String TAG=Mythree.class.getSimpleName();
    private Paint mPaint;
    private RectF oval;

    public Mysix(Context context){
        super(context);
        init();
    }

    public Mysix(Context context, AttributeSet attrs){
        super(context, attrs);
        init();
    }

    public Mysix(Context context, AttributeSet attrs, int defStyleAttr){
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(oval,360,60,true,mPaint);
